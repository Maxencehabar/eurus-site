...
const projects: ProjectDetail[] = [
  {
    ...
    description:
      "App de matching qui met en relation des voyageurs partageant les mêmes destinations et dates. Disponible sur iOS avec plus de 7 000 utilisateurs actifs.",
    tags: ["Flutter", "Firebase", "iOS"],
    category: "mobile",
    stat: "7 000+ utilisateurs",
    ...
    results: [
      { value: "7 000+", label: "Utilisateurs actifs" },
    ...
    metaDescription:
      "Découvrez Getaway, l'application mobile de matching entre voyageurs développée par Eurus. Flutter, Firebase, 7 000+ utilisateurs actifs.",
  },
  {
    number: "02",
