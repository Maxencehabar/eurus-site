          ...
          <motion.div variants={fadeUp}>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-text-primary">France</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-8 border-t border-border">
              <p className="text-sm text-text-muted mb-4">
                Gratuit, sans engagement — 30 min pour comprendre votre besoin.
              </p>
              <div className="flex gap-4">
                <a
                  href="https://www.linkedin.com/company/eurus-agency"
                  target="_blank"
                ...
                <a
                  href="https://github.com/eurus-agency"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-text-muted hover:text-accent hover:border-accent transition-colors"
                >
