...
export type SocialIconType = "linkedin" | "github" | "twitter";
...
interface SocialIconProps extends Omit<SVGProps<SVGSVGElement>, "children"> {
  type: SocialIconType;
}

export function SocialIcon({ type, ...rest }: SocialIconProps) {
  return (
