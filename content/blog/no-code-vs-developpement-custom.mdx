...
Sur Youdy, notre application sociale, on a dû refaire 3 fois le système de [notifications push](/blog/notifications-push-guide-complet) avant de trouver le bon équilibre entre engagement et spam. Ce genre d'optimisation fine ? Impossible sur une plateforme no-code. Vous êtes limité aux options que l'éditeur a prévu pour vous.
