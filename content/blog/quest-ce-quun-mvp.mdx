...
Ce calendrier suppose une équipe dédiée (voir notre guide sur les [étapes de développement d'une application](/blog/etapes-developpement-application)) et un périmètre fonctionnel bien défini. Si le cadrage est flou ou si le scope evolue en permanence, les délais explosent inévitablement.
