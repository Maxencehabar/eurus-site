...
En pensant offline-first, vous inversez la logique. Les données locales deviennent la source de vérité. Le serveur est là pour synchroniser, pas pour tout gérer. Concrètement, ça change tout pour l'[expérience utilisateur](/blog/design-ux-application-mobile).
...
**Chrome DevTools** — Pour les [PWA](/blog/pwa-vs-application-native), on peut simuler offline et différents profils réseau.
