...
En termes de [temps de développement](/blog/combien-temps-developper-application), voici des ordres de grandeur réalistes :
...
**Système d'abonnement (StoreKit + Google Play Billing + sync serveur)** : 2-3 semaines. C'est beaucoup plus complexe à cause de la synchronisation [cross-platform](/blog/native-vs-cross-platform).
