...
Base de données, authentification, stockage fichiers, fonctions serverless... Vous pouvez soit tout coder vous-même, soit utiliser un Backend-as-a-Service (BaaS). Mais entre [Firebase](/blog/backend-as-a-service-comparatif) (Google), [Supabase](/blog/backend-as-a-service-comparatif) (l'outsider open source), et un backend custom, lequel choisir ?
...
Firebase est le [BaaS](/blog/backend-as-a-service-comparatif) de Google, lancé en 2011 (acquis en 2014). Il offre une suite complète : base de données NoSQL (Firestore), authentification, stockage, hosting, Cloud Functions, analytics, crash reporting, et depuis 2024, une intégration poussée avec les modèles IA de Google.
