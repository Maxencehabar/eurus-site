...
Concrètement, ça veut dire que votre code sera différent sur les deux plateformes. Si vous utilisez [Flutter ou React Native](/blog/flutter-vs-react-native-2026), les plugins abstraient une partie de cette complexité, mais pas tout.
