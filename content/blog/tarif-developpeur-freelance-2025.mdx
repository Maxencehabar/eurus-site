...
Certains freelances proposent aussi un forfait projet, mais c'est généralement réservé aux missions très bien définies, avec un [cahier des charges](/blog/cahier-des-charges-application-mobile) béton. Et même là, ils ajoutent une marge de sécurité pour couvrir les imprévus.
...
Flutter et React Native dominent le marché [cross-platform](/blog/native-vs-cross-platform). Les développeurs Flutter sont particulièrement demandés depuis 2023, et ça se ressent sur les tarifs.
