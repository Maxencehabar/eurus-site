...
Le revers : ça n'existe pas sur Android. Si vous faites du [cross-platform](/blog/native-vs-cross-platform), vous devrez maintenir deux implémentations différentes.
...
Un scanner QR code, ce n'est pas juste une caméra avec un décodeur. L'interface compte énormément pour l'[expérience utilisateur](/blog/design-ux-application-mobile).
