...
En fait, ça dépend. Si vous l'intégrez dès le début du projet, le surcoût est estimé entre 5 et 10% du [budget de développement](/blog/cout-application-mobile). C'est de la conception en plus, des tests en plus, mais c'est intégré au flux normal.
