...
Quand un client arrive avec un projet d'application mobile, la question du choix technologique surgit toujours. Et parmi les débats les plus récurrents : faut-il partir sur du natif ou du [cross-platform](/blog/native-vs-cross-platform) ? Si la réponse est "natif", alors on entre dans un autre débat : Kotlin pour Android, Swift pour iOS. Deux langages modernes, deux écosystèmes, deux philosophies.
...
Avant d'entrer dans le vif du sujet, une question légitime : pourquoi s'intéresser au [développement natif](/blog/native-vs-cross-platform) alors que Flutter et React Native dominent les discussions ?
