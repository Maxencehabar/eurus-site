...
Pour chaque feedback actionnable, posez-vous deux questions : quel impact sur l'[expérience utilisateur](/blog/design-ux-application-mobile) ? Quel effort pour le corriger ou l'implémenter ?
