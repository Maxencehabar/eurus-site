...
Un BaaS, c'est une plateforme qui vous fournit les briques essentielles d'un backend sans que vous ayez à les construire vous-même. Authentification, base de données, stockage de fichiers, fonctions serverless, [notifications push](/blog/notifications-push-guide-complet) — tout est prêt à l'emploi.
