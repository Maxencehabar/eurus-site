...
Et si vous pensez que c'est secondaire par rapport aux fonctionnalités, détrompez-vous. Une étude de Forrester montre qu'un bon design UX peut augmenter les taux de conversion de 400%. Quatre cents pour cent. On n'invente rien.
...
Du coup, l'accessibilité améliore l'UX pour tout le monde. Un bon contraste aide aussi dans les environnements lumineux. Des zones de tap larges facilitent l'utilisation à une main. Concevoir pour l'accessibilité, c'est concevoir mieux, point final.
