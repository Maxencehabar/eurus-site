...
**Time to completion** : temps entre le début de la parole et l'exécution de l'action. Cible : <3 secondes pour les actions simples.

**Fallback rate** : pourcentage de requêtes nécessitant un retour à l'interface tactile. Cible : <15%.
